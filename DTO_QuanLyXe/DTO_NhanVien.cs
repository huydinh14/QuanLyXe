...
namespace DTO_QuanLyXe
{
    public class DTO_NhanVien
    {
        ...
        public bool GioiTinh { get => _BGioiTinh; set => _BGioiTinh = value; }
        ...
        public DTO_NhanVien(string manv, string tennv, DateTime ngaysinh, string cmnd, string sdt, string diachi, bool gioitinh)
        {
            this.StrMaNV = manv;
            this.StrTenNV = tennv;
